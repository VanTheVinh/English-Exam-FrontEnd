    ...
    return (
        <div className={styles.manage_classes}>
            <table className={styles.tables}>
                    ...
                    {popup == 1?<><tr className={styles.popup}>
                                    <td></td>
                                    <td><input id='input1'></input></td>
                                    <td><input id='input2'></input></td>
                    ...
                    cla.map((e)=>{
                        ...
                        <>
                            <tr className={styles.tr}>
                                <td>{stt}</td>
                                <td>{e.classCode}</td>
                                <td>{e.__v == 1 && edi == 1?<input onKeyDown={editLisenclassname} id={e._id} defaultValue={e.className}></input>:e.className}</td>
                                <td><span onClick={()=>{e.__v = 1 
                                    setEdit(1)
                                }} className="material-symbols-outlined">edit</span></td>
                                <td><span onClick={()=>{detele(e._id)}} className="material-symbols-outlined">delete</span></td>
                            </tr>
